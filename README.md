**This is not hard to integrate with your own skins**
**Step 1.**
Open the RP folder, inside you will see a textures folder, inside that you will see an entities folder, inside the entities folder you will see the files you need.
**Step 2.**
Delete the files in the that folder that have "texture_set" in the name, it is **important** that you do this or it will add a weird glow to your skin in game. Also delete the file name "basic_mers.png"
**Step 3.**
